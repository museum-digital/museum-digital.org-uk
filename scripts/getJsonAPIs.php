...
$feeds = [
    ...
    MATOMO_BASE . '?date=' . date("Y-m-d", strtotime("-1 month")) . ',' . date("Y-m-d") . '&expanded=1&filter_limit=100&format=JSON&format_metrics=1&idSite=1&method=API.get&module=API&period=day&token_auth=anonymous' => 'md_users_stats',
